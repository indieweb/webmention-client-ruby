...
webmention-client-ruby is developed using Ruby 2.4.6 and is additionally tested against Ruby 2.5.3 and 2.6.1 using [Travis CI](https://travis-ci.org/indieweb/webmention-client-ruby).
